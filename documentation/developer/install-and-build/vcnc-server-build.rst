...
*vcnc-server* has two build processes.  The *internal* process works with artifacts
...
Refer to :ref:`vcnc_server_external_build` when building *vcnc-server* to be compatible with
a PeerCache development build. Refer to :ref:`vcnc_server_internal_build` when building vCNC
